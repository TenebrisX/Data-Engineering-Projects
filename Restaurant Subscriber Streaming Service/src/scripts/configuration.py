...
KAFKA_SASL_CONFIG = os.environ.get('KAFKA_SASL_CONFIG',  'org.apache.kafka.common.security.scram.ScramLoginModule required username="de-student" password=\"*****\";')
...
POSTGRES_PASSWORD_CLOUD = os.environ.get('POSTGRES_PASSWORD_CLOUD',  "*****")
